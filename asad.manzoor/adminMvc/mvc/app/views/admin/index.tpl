{include file="/var/www/html/mvc/app/views/admin/header.tpl" title=""}
...
<script src="/mvc/lib/template/bower_components/raphael/raphael-min.js"></script>
<script src="/mvc/lib/template/bower_components/morrisjs/morris.min.js"></script>
<script src="/mvc/lib/template/js/morris-data.js"></script>

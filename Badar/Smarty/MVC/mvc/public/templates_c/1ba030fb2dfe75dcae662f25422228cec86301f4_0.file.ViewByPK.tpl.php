<?php
/* Smarty version 3.1.29, created on 2016-08-01 04:59:02
  from "/var/www/html/MVC/mvc/app/views/home/ViewByPK.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_579ed71672f584_22812969',
  'file_dependency' => 
  array (
    '1ba030fb2dfe75dcae662f25422228cec86301f4' => 
    array (
      0 => '/var/www/html/MVC/mvc/app/views/home/ViewByPK.tpl',
      1 => 1470027515,
      2 => 'file',
    ),
  ),
...
function content_579ed71672f584_22812969 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Select by PK</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <form role="form" action="http://localhost/MVC/mvc/public/home/SelectPK" method ="post">
                                    <fieldset>

                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" placeholder="Enter text" type="text" name="SlctPkTxt">
                                        </div>

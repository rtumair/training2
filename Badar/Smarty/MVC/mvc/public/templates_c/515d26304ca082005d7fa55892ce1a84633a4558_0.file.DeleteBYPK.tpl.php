<?php
/* Smarty version 3.1.29, created on 2016-08-01 04:59:04
  from "/var/www/html/MVC/mvc/app/views/home/DeleteBYPK.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_579ed718b20513_21330123',
  'file_dependency' => 
  array (
    '515d26304ca082005d7fa55892ce1a84633a4558' => 
    array (
      0 => '/var/www/html/MVC/mvc/app/views/home/DeleteBYPK.tpl',
      1 => 1470027528,
      2 => 'file',
    ),
  ),
...
function content_579ed718b20513_21330123 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Delete by PK</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <form role="form" action="http://localhost/MVC/mvc/public/home/DeletebyPK" method ="post">
                                    <fieldset>

                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" placeholder="Enter text" type="text" name="DeletePkTxt">
                                        </div>
